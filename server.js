...
async function api(req,res,url){
  if(req.method==='GET'&&url.pathname==='/api/health')return json(res,200,{status:'ok',service:'nhanes-research-agent',version:'2.21.0',mode:'agent-orchestrated-mvp',authEnabled:auth.enabled,shuttingDown});
