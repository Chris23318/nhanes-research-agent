...
function markdownReport(project, result) { const main = exposureRow(result), sensitivity = sensitivityRows(result), flow = result.flow || {}; return `# ${project.title || 'NHANES 流行病学研究报告'}
